 ...
 */
async function runMinecraftBackup(target: string): Promise<{ success: boolean; message: string; details?: unknown }> {
 ...
 */
async function runTrueNASSnapshot(target: string): Promise<{ success: boolean; message: string; details?: unknown }> {
